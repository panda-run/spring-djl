...
public final class TrainCaptcha {
    ...
    public static TrainingResult runExample(String[] args) throws ParseException, Exception {
    ...
    private static RandomAccessDataset getDataset(Usage usage, Arguments arguments)
            throws IOException {
